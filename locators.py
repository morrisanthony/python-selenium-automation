...
driver.find_element(By. XPATH, "//input[@tableindex= '0' and @name= field-keywords and @dir= auto']")
driver.find_element(By. XPATH, "//input[@tableindex= '0' and @name='field-keywords']")

# by XPATH, text():
driver.find_element(By.XPATH, "//a[text()='Best Sellers")

# by XPATH, text() + attr:
driver.find_element(By.XPATH,"//a[text()=['Best Search Results' and @class='nav-a']")
