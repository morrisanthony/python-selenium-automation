...
# CSS
driver.find_element(By.ID, "twoabsearchtextbox")
# CSS, by id:
driver.find_element(By.CSS_SELECTOR, "twoabsearchtextbox")
# CSS, by id & tag
driver.find_element(By.CSS_SELECTOR, "input#twoabsearchtextbox")
# CSS, by class
...
driver.find_element(By.CSS_SELECTOR, 'input#twoabsearchtextbox.nav-progressive-attribute.nav-input')
